//simplest application: checkout and load a single commit

//is this better as a bash script that uses git directly?
...
//bash path
//git checkout
//run some other build script
//git checkout repeated